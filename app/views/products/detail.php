...
<div class="product-detail">
    <div class="container">
        ...
        <div class="product-content">
            ...
            <div class="product-info">
                ...
                <div class="product-stats">
                    <small>👁️ <?php echo $data['produto']['visualizacoes']; ?> <?php echo __('product.view_count'); ?></small>
                    <small>📅 <?php echo __('product.published_on'); ?> <?php echo date('d/m/Y', strtotime($data['produto']['created_at'])); ?></small>
                </div>
            </div>
        </div>
        ...
        <section class="avaliacoes-section">
            <h2>⭐ <?php echo __('product.reviews'); ?></h2>
