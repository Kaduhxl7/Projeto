...
<head>
    ...
    <!-- Preload transition scripts -->
    <link rel="preload" href="assets/js/pageTransition.js" as="script">
    <link rel="preload" href="assets/js/transition-enhancements.js" as="script">
    
    <!-- Custom CSS -->
    <link rel="stylesheet" href="assets/css/style.css">
    <link rel="stylesheet" href="assets/css/page-transitions.css">
    <link rel="stylesheet" href="assets/css/transition-effects.css">
    ...
    <header role="banner">
        ...
        <nav role="navigation" aria-label="Menu principal">
            ...
            <?php if(isset($_SESSION['user_id'])): ?>
                ...
                <a href="logout.php" aria-label="<?php echo __('nav.logout'); ?>">
                    <img src="assets/Ícones/sair.png" alt="Sair" style="width: 20px; height: 20px; vertical-align: middle;">
                </a>
            <?php else: ?>
            ...
            <?php if(isset($_SESSION['user_id'])): ?>
                <div class="notification-bell">
                    <a href="notifications.php" class="bell-link" title="<?php echo __('notifications.bell_title'); ?>">
                        <img src="assets/Ícones/alfinete.png" alt="Notificações" style="width: 20px; height: 20px;">
