<?php
$page_title = __('categories.' . $data['categoria']['slug']) . " - " . __('site.title');
...
<div class="category-page">
    <div class="container">
        <div class="page-header">
            <h1><?php echo __('categories.' . $data['categoria']['slug']); ?></h1>
            <p><?php echo __('categories.' . $data['categoria']['slug'] . '_description'); ?></p>
            ...
            <aside class="filters-sidebar">
                ...
                <form method="GET" action="" id="filtersForm">
                    ...
                    <div class="filter-actions">
                        ...
                        <a href="?cat=<?php echo htmlspecialchars($data['categoria']['slug']); ?>" class="btn-clear"><?php echo __('search.clear_filters'); ?></a>
                    </div>
                </form>
            </aside>
                ...
                <div class="products-grid">
                    <?php if (empty($data['produtos'])): ?>
                        <div class="no-products">
                            ...
                            <p><?php echo __('messages.no_items'); ?></p>
                        </div>
                    <?php else: ?>
